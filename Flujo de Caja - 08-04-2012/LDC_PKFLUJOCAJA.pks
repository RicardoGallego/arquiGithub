CREATE OR REPLACE PACKAGE LDC_PKFLUJOCAJA AS

/************************************************************************
 PROPIEDAD INTELECTUAL DE SURTIGAS S.A. E.S.P

 PROCEDIMIENTO : LDC_PKFLUJOCAJA
 ...
 Parametros de Entrada
    ...
    iNuDocumento IN LDC_ENCAINTESAO.NUM_DOCUMENTOSAP%TYPE
 ...
 Hector Dominguez   22-07-2011    Modificacion para incluir actividades.151734
************************************************************************/

PROCEDURE proEnvFlujoCaja (nuAno   in   LDC_FLUJOCAJA.ANO%TYPE,
                           nuMes   in   LDC_FLUJOCAJA.MES%TYPE,
                           dtDia   IN   ldc_flujocaja.fecha_doc%TYPE
);
...
PROCEDURE proEnvFlujoCaja (nuAno   in   LDC_FLUJOCAJA.ANO%TYPE,
                           nuMes   in   LDC_FLUJOCAJA.MES%TYPE,
                           dtDia   IN   ldc_flujocaja.fecha_doc%TYPE) AS
